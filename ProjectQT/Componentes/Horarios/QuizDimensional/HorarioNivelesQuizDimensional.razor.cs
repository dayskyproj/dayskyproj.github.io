...
namespace ProjectQT.Componentes.Horarios.QuizDimensional
{
    public class HorarioNivelesQuizDimensionalBase : ComponentBase
    {
        ...
        [Parameter]
        public List<GuiaPreguntaTiempoDimensional> Tiempos { get; set; } = new();
